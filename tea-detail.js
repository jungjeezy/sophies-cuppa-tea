...
(function () {
  ...
  const editorialPages = {
    'Plush Peak': {
      ...
      contextLabel: 'Traditional Context',
      ...
      valueBody: 'Plush Peak is priced as an approachable entry point, but the tea still carries the standards that matter: organic cultivation, clean flavor, careful brewing, and a clear sense of place.',
